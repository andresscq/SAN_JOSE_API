        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 font-bold mt-6 uppercase tracking-[0.2em] text-sm">
              Forma parte de la familia Distribuidora San José
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 bg-white p-8 md:p-14 rounded-[50px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-50">
            ...
            <div className="space-y-8">
              <div className="bg-green-900 text-white p-10 rounded-[40px] relative overflow-hidden shadow-xl">
                ...
                <p className="text-green-100 mb-8 leading-relaxed font-medium">
                  Personas comprometidas, con ganas de crecer y que compartan
                  nuestros valores.
                </p>
              ...
              <div className="p-8 bg-yellow-50 rounded-[40px] border-2 border-dashed border-yellow-200">
                ...
                <p className="text-green-800 text-xs leading-relaxed font-semibold">
                  Completa todos los campos y adjunta tu Hoja de Vida en PDF.{" "}
                  <br />
            ...
            {/* Formulario Derecha con MENSAJE DE ÉXITO ANTIGUO */}
            {enviado ? (
              <div className="flex flex-col items-center justify-center text-center space-y-6 animate-fadeIn py-10">
                ...
                <p className="text-slate-500 font-medium px-4">
                  Hemos recibido tu información con éxito. Estaremos en contacto
                  contigo pronto vía WhatsApp.
                </p>
                <button
                  onClick={() => setEnviado(false)}
                  className="text-green-700 font-black uppercase text-[10px] tracking-widest hover:text-yellow-500 border-b-2 border-yellow-400 pb-1 transition-all"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 focus:border-yellow-400 focus:bg-white outline-none transition-all font-bold text-slate-700 shadow-inner"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between px-2 mt-1">
                    <span
                      className={`text-[9px] font-black ${formData.telefono.length === 10 ? "text-green-500" : "text-slate-300"}`}
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      type="number"
                      className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 focus:border-yellow-400 outline-none transition-all font-bold text-slate-700 shadow-inner"
                    />
                  </div>
                  <div>
                    <label className="text-[10px] font-black uppercase text-slate-400 ml-2 mb-2 block tracking-widest">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 focus:border-yellow-400 outline-none transition-all font-bold text-slate-700 appearance-none shadow-inner"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-4 focus:border-yellow-400 outline-none transition-all font-bold text-slate-700 resize-none shadow-inner"
                  ></textarea>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-[10px] font-bold text-slate-400 file:mr-4 file:py-4 file:px-8 file:rounded-2xl file:border-0 file:text-[10px] file:font-black file:uppercase file:bg-green-800 file:text-white hover:file:bg-yellow-400 hover:file:text-green-900 cursor-pointer transition-all shadow-sm"
                  />
                </div>
